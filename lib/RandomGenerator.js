...
/**
 * run the generator with constructor options
 */
 ...
 * @param  {[type]} number of points to generate
 * @param  {[type]} bbox   [description]
 * @return FeatureCollection generated random points
 */
RandomGenerator.prototype.random = function(number, bbox) {
  // TODO: test number and bbox
  return this._random(number, bbox);
};

// RandomGenerator.prototype.randomWithGeojson = function(number, geojson) {
//     this.options.input = geojsonFile
//     this.options.number =
//     return this._random(number, bbox);
// };

...
const argv = yargs(process.argv.slice(2))
  ...
  .example('$0 -n 1000 --xmin=-2 --xmax=4 --ymin=-45 --ymax=50',
    'Generates 1000 random coordinates with thsese bounding box')
  .example('$0 -i world_countries.geojson',
...
if (options.verbose) {
  console.log('Runing random-points-generator with', util.inspect(argv, {
    depth: null,
  }));
}
if (argv.xmin !== undefined && argv.ymin !== undefined &&
  argv.xmax !== undefined && argv.ymax !== undefined) {
